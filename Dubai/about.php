<?php $page_title = "About Us | Trusted Glass Hardware & Architectural Fittings Manufacturers in Dubai";
$description = "Learn more about our expertise as a leading manufacturer of glass partitions, sliding systems, shower fittings, patch fittings, spider fittings, floor springs, and architectural hardware in Dubai. Committed to quality, innovation, and precision engineering.";
$keyword = "About glass fittings company Dubai,Architectural hardware manufacturers Dubai,Glass Partition company Dubai,Sliding system manufacturers Dubai,Patch Fitting company Dubai,Shower fittings manufacturers Dubai,Glass hardware exporters Dubai,Premium glass fittings Dubai";
include('header.php') ?>
