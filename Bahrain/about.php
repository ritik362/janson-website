<?php $page_title = "About Us | Trusted Glass Hardware & Architectural Fittings Manufacturers in Bahrain";
$description = "Learn more about our expertise as a leading manufacturer of glass partitions, sliding systems, shower fittings, patch fittings, spider fittings, floor springs, and architectural hardware in Bahrain. Committed to quality, innovation, and precision engineering.";
$keyword = "About glass fittings company Bahrain,Architectural hardware manufacturers Bahrain,Glass Partition company Bahrain,Sliding system manufacturers Bahrain,Patch Fitting company Bahrain,Shower fittings manufacturers Bahrain,Glass hardware exporters Bahrain,Premium glass fittings Bahrain";
include('header.php') ?>
