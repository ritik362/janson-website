<?php $page_title = "About Us | Trusted Glass Hardware & Architectural Fittings Manufacturers in Chennai";
$description = "Learn more about our expertise as a leading manufacturer of glass partitions, sliding systems, shower fittings, patch fittings, spider fittings, floor springs, and architectural hardware in Chennai. Committed to quality, innovation, and precision engineering.";
$keyword = "About glass fittings company Chennai,Architectural hardware manufacturers Chennai,Glass Partition company Chennai,Sliding system manufacturers Chennai,Patch Fitting company Chennai,Shower fittings manufacturers Chennai,Glass hardware exporters Chennai,Premium glass fittings Chennai";
include('header.php') ?>
