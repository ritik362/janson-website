<?php $page_title = "About Us | Trusted Glass Hardware & Architectural Fittings Manufacturers in Kathmandu";
$description = "Learn more about our expertise as a leading manufacturer of glass partitions, sliding systems, shower fittings, patch fittings, spider fittings, floor springs, and architectural hardware in Kathmandu. Committed to quality, innovation, and precision engineering.";
$keyword = "About glass fittings company Kathmandu,Architectural hardware manufacturers Kathmandu,Glass Partition company Kathmandu,Sliding system manufacturers Kathmandu,Patch Fitting company Kathmandu,Shower fittings manufacturers Kathmandu,Glass hardware exporters Kathmandu,Premium glass fittings Kathmandu";
include('header.php') ?>
